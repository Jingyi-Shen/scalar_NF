...
from models.modules.flows.linear import GatedConv1D
from models.modules.flows.linear import Conv1DZeros
...
class AugmentLayer(nn.Module):
    ...
    def __init__(self, dist: GaussianDistribution, aug_channel: int, shallow_net: nn.Module, argument_steps: nn.ModuleList):
